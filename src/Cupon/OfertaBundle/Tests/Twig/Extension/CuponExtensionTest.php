...
class TwigExtensionTest extends \PHPUnit_FrameWork_TestCase
{
    public function testDescuento()
    {
        ...
        $this->assertEquals('-80%', $extension->descuento(2, 8),
            'Si el precio de venta son 2 euros y el descuento sobre el
            prcio original son 8 euros, el descuento es -80%');
        $this->assertEquals('-33%', $extension->descuento(10, 5),
            'Si el precio de venta son 10 euros u el descuento sobre el precio
